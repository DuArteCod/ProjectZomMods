...
-- Adiciona opções de contexto para VerdinhaBox e VerdinhaPack (Abrir / Pegar Verdinha)
...
local function createSingleFromPack(playerObj, packItem)
    ...
    if packCount and packCount > 1 then
        ...
        -- remove o pack se era a última unidade
...
local function openPackFromBox(playerObj, boxItem)
    ...
    -- adicionar 10 maços VerdinhaPack
    for i = 1, 10 do
...
local function onFillInventoryObjectContextMenu(player, context, items)
    ...
    for _, item in ipairs(items) do
        ...
        elseif t == "VerdinhaPack" then
            ...
            -- fumar direto já é tratado pelo Smokeable do item; não precisamos adicionar "Fumar" manualmente
        end
    end
end
